...
const accounts = [
  {
    ...
    realFollowers: 94, score: 91, price: 45,
  ...
  },
  {
    ...
    realFollowers: 91, score: 93, price: 65,
  ...
  },
  {
    ...
    realFollowers: 89, score: 90, price: 55,
    audience: "72% O'zbekiston", badge: "verified",
    description: "Fitness va sog'lom turmush tarzi haqida. Trening mashqlari va dietalar. Faol hamjamiyat.",
  ...
  },
  {
    ...
    realFollowers: 96, score: 95, price: 40,
    audience: "95% Ayollar", badge: "top",
    description: "Go'zallik sirlari va makiyaj darslari. Mahsulot sharhlari. Yuqori engagement rate.",
  ...
  },
  {
    ...
    followers: 3200, er: 4.9, posts: 145, age: "2 yil",
    realFollowers: 87, score: 88, price: 90,
  ...
  },
  {
    ...
    realFollowers: 93, score: 92, price: 35,
  ...
  },
  {
    ...
    realFollowers: 97, score: 97, price: 42,
  ...
  },
  {
    ...
    followers: 2400, er: 5.5, posts: 132, age: "1 yil 9 oy",
    realFollowers: 90, score: 91, price: 70,
...
function saveUser(u) { localStorage.setItem('im_user', JSON.stringify(u)); }
function logoutUser() { localStorage.removeItem('im_user'); }
...
// ===== MARKETPLACE CARD (pages/ ichida) =====
function renderAccountCard(acc) {
  return renderCard(acc, '../');
}
